...
public class ChangeDisplayTask extends AsyncTask<String, Void, String[]> {
    ...
    public ChangeDisplayTask(Activity activity) {
        this.activity = activity;
    }

    //sends a message to a server telling it to change the current display setting
    @Override
    protected String[] doInBackground(String... HostOutIn) {
        try {
            ...
            out.println("LONGHEXNUMBERHERE DISPLAY " + HostOutIn[2]);
            out.flush();
            out.close();
