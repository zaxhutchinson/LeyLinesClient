...
public class TogglePathTask extends AsyncTask<String, Void, String[]> {
    ...
    public TogglePathTask(Activity activity) {
        this.activity = activity;
    }

    //sends a message to a server telling it to change the current path setting
    @Override
    protected String[] doInBackground(String... HostOutIn) {
        try {
            ...
            out.println("LONGHEXNUMBERHERE PATH " + HostOutIn[2]);
            out.flush();
            out.close();
